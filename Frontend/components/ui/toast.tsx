...
type ToastVariant = "default" | "destructive" | "info" | "warning" | "success";

const Toast = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Root>,
  ToastPrimitives.ToastProps & { variant?: ToastVariant }
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-inherit opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2",
      className
    )}
    toast-close=""
    {...props}
